...
summary(model_sim)
#> Time used:
#>     Pre = 2.06, Running = 2.61, Post = 0.191, Total = 4.86 
#> Fixed effects:
#>          mean    sd 0.025quant 0.5quant 0.975quant  mode kld
#> beta.0  1.044 0.218      0.623    1.046      1.454 1.040   0
#> beta.z  1.940 0.387      1.242    1.933      2.610 1.934   0
...
#> Precision for the Gaussian observations    1.134 0.393      0.559    1.070       2.08 0.951
#> Precision for the Gaussian observations[2] 1.141 0.352      0.606    1.089       1.98 0.991
#> Precision for the Gaussian observations[3] 0.927 0.111      0.726    0.921       1.16 0.911
#> Precision for the Gaussian observations[4] 0.978 0.127      0.755    0.969       1.25 0.950
#> Beta for beta.x                            1.979 0.202      1.584    1.977       2.38 1.972
#> 
#> Marginal log-Likelihood:  -20699.95 
#>  is computed 
...
summary(model_mnar)
#> Time used:
#>     Pre = 2.05, Running = 3.59, Post = 0.18, Total = 5.81 
#> Fixed effects:
#>            mean    sd 0.025quant 0.5quant 0.975quant   mode kld
#> beta.0    1.038 0.050      0.940    1.038      1.137  1.038   0
#> beta.z1   2.004 0.036      1.932    2.004      2.075  2.004   0
...
#> gamma.0  -1.509 0.122     -1.755   -1.508     -1.273 -1.508   0
...
#> Model hyperparameters:
#>                                              mean    sd 0.025quant 0.5quant 0.975quant   mode
#> Precision for the Gaussian observations     0.983 0.048      0.892    0.982      1.081  0.980
#> Precision for the Gaussian observations[2]  1.139 0.387      0.581    1.073      2.083  0.950
#> Precision for the Gaussian observations[3]  1.023 0.048      0.934    1.022      1.121  1.018
#> Beta for beta.x                             1.953 0.035      1.883    1.953      2.020  1.955
#> Beta for gamma.x                           -0.036 0.089     -0.211   -0.036      0.139 -0.036
#> 
#> Marginal log-Likelihood:  -11663.15 
#>  is computed 
#> Posterior summaries for the linear predictor and the fitted values are computed
#> (Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
```
